import { c as create_ssr_component, d as createEventDispatcher, e as escape, v as validate_component, f as each } from "../../chunks/ssr.js";
...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.data === void 0 && $$bindings.data && data !== void 0)
    $$bindings.data(data);
  $$result.css.add(css);
  return `${validate_component(LoginModal, "LoginModal").$$render($$result, { show }, {}, {})} ${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {})} <h3 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white svelte-wyijx3" data-svelte-h="svelte-xd7bsq">Latest Blogs</h3> ${each(data?.blogs, (idc, i) => {
